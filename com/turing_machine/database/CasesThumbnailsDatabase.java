		...
		*/
		...
		this.cases.add(
			new CriterionCaseThumbnail(98, "bleu plus jaune vaut 4",
				(Graphics g2D) -> {
					ImageDescriptable.drawIndex(g2D, CodeIndex.FIRST_BLUE_TRIANGLE, 25, 30, 25);
					
					g2D.setColor(Color.BLACK);
					ImageDescriptable.drawPlus(g2D, 50, 30, 30);

					ImageDescriptable.drawIndex(g2D, CodeIndex.SECOND_YELLOW_SQUARE, 75, 30, 25);

					g2D.setColor(Color.BLACK);
					ImageDescriptable.drawEquals(g2D, 100, 30, 30);

					ImageDescriptable.draw4Value(g2D, 125, 30, 30);
		...
		this.cases.add(
			new CriterionCaseThumbnail(100, "bleu plus jaune vaut 6",
				(Graphics g2D) -> {
					...
					ImageDescriptable.draw6Value(g2D, 125, 30, 30);
				}
			)
		);
		...
		this.cases.add(
			new CriterionCaseThumbnail(103, "bleu plus violet vaut 4",
				(Graphics g2D) -> {
					...
					ImageDescriptable.drawIndex(g2D, CodeIndex.THIRD_PURPLE_CIRCLE, 75, 30, 25);
		...
		this.cases.add(
			new CriterionCaseThumbnail(108, "jaune plus violet vaut 4",
				(Graphics g2D) -> {
					ImageDescriptable.drawIndex(g2D, CodeIndex.SECOND_YELLOW_SQUARE, 25, 30, 25);
		...
		this.cases.add(
			new CriterionCaseThumbnail(113, "bleu est le plus grand",
				(Graphics g2D) -> {
					ImageDescriptable.drawIndex(g2D, CodeIndex.FIRST_BLUE_TRIANGLE, 40, 30, 20);
					
					g2D.setColor(Color.BLACK);
					ImageDescriptable.drawGreaterThan(g2D, 75, 30, 20);

					ImageDescriptable.drawIndex(g2D, CodeIndex.SECOND_YELLOW_SQUARE, 105, 20, 10);
					ImageDescriptable.drawIndex(g2D, CodeIndex.THIRD_PURPLE_CIRCLE, 105, 40, 10);
				}
			)
		);
		...
		this.cases.add(
			new CriterionCaseThumbnail(114, "jaune est le plus grand",
				(Graphics g2D) -> {
					ImageDescriptable.drawIndex(g2D, CodeIndex.SECOND_YELLOW_SQUARE, 40, 30, 20);
					
					g2D.setColor(Color.BLACK);
					ImageDescriptable.drawGreaterThan(g2D, 75, 30, 20);

					ImageDescriptable.drawIndex(g2D, CodeIndex.FIRST_BLUE_TRIANGLE, 105, 20, 10);
					ImageDescriptable.drawIndex(g2D, CodeIndex.THIRD_PURPLE_CIRCLE, 105, 40, 10);
				}
			)
		);
		...
		this.cases.add(
			new CriterionCaseThumbnail(115, "violet est le plus grand",
				(Graphics g2D) -> {
					ImageDescriptable.drawIndex(g2D, CodeIndex.THIRD_PURPLE_CIRCLE, 40, 30, 20);
					
					g2D.setColor(Color.BLACK);
					ImageDescriptable.drawGreaterThan(g2D, 75, 30, 20);

					ImageDescriptable.drawIndex(g2D, CodeIndex.FIRST_BLUE_TRIANGLE, 105, 20, 10);
					ImageDescriptable.drawIndex(g2D, CodeIndex.SECOND_YELLOW_SQUARE, 105, 40, 10);
				}
			)
		);
		...
		this.cases.add(
			new CriterionCaseThumbnail(119, "trois fois un même chiffre",
				(Graphics g2D) -> {
					ImageDescriptable.draw2Value(g2D, 55, 30, 20);
					ImageDescriptable.draw2Value(g2D, 75, 30, 20);
					ImageDescriptable.draw2Value(g2D, 95, 30, 20);
		...
		this.cases.add(
			new CriterionCaseThumbnail(120, "deux fois un même chiffre",
				(Graphics g2D) -> {
					ImageDescriptable.draw1Value(g2D, 55, 30, 20);
					ImageDescriptable.draw1Value(g2D, 75, 30, 20);
					ImageDescriptable.draw2Value(g2D, 95, 30, 20);
		...
		this.cases.add(
			new CriterionCaseThumbnail(121, "aucune répétition",
				(Graphics g2D) -> {
					ImageDescriptable.draw1Value(g2D, 55, 30, 20);
					ImageDescriptable.draw2Value(g2D, 75, 30, 20);
					ImageDescriptable.draw5Value(g2D, 95, 30, 20);
				}
			)
		);
		...
		this.cases.add(
			new CriterionCaseThumbnail(122, "aucune séquence croissante ou décroissante",
				(Graphics g2D) -> {
					ImageDescriptable.draw0Value(g2D, 60, 30, 30);
					g2D.setColor(new Color(0xF36322));
					ImageDescriptable.drawTopDownArrows(g2D, 90, 30, 30);
				}
			)
		);
		...
		this.cases.add(
			new CriterionCaseThumbnail(125, "bleu est le/l'un des plus grand(s)",
				(Graphics g2D) -> {
					...
					g2D.setColor(Color.BLACK);
					ImageDescriptable.drawGreaterEqualThan(g2D, 75, 30, 20);
		...
		this.cases.add(
			new CriterionCaseThumbnail(128, "bleu est le/l'un des plus petit(s)",
				(Graphics g2D) -> {
					...
					g2D.setColor(Color.BLACK);
					ImageDescriptable.drawLowerEqualThan(g2D, 75, 30, 20);
		...
		this.cases.add(
			new CriterionCaseThumbnail(131, "il y a plus de nombres pairs",
				(Graphics g2D) -> {
					ImageDescriptable.drawText(g2D, "pair", 20, 30, 15);
					
					g2D.setColor(Color.BLACK);
					ImageDescriptable.drawGreaterThan(g2D, 60, 30, 30);

					ImageDescriptable.drawText(g2D, "impair", 80, 30, 15);
				}
			)
		);
		...
		this.cases.add(
			new CriterionCaseThumbnail(132, "il y a plus de nombres impairs",
				(Graphics g2D) -> {
					...
					g2D.setColor(Color.BLACK);
					ImageDescriptable.drawLowerThan(g2D, 60, 30, 30);
		...
		this.cases.add(
			new CriterionCaseThumbnail(133, "les nombres sont dans l'ordre croissant",
				(Graphics g2D) -> {
					g2D.setColor(new Color(0xF36322));
					ImageDescriptable.drawPodium(g2D, 1, 2, 3, 75, 30, 30);
				}
			)
		);
		...
		this.cases.add(
			new CriterionCaseThumbnail(134, "les nombres sont dans l'ordre décroissant",
				(Graphics g2D) -> {
					g2D.setColor(new Color(0xF36322));
					ImageDescriptable.drawPodium(g2D, 3, 2, 1, 75, 30, 30);
				}
			)
		);
		...
		this.cases.add(
			new CriterionCaseThumbnail(135, "aucun ordre particulier",
				(Graphics g2D) -> {
					g2D.setColor(new Color(0xF36322));
					ImageDescriptable.drawPodium(g2D, 3, 1, 2, 75, 30, 30);
				}
			)
		);
		...
		this.cases.add(
			new CriterionCaseThumbnail(136, "la somme de bleu et jaune est supérieure à 6",
				(Graphics g2D) -> {
					...
					g2D.setColor(Color.BLACK);
					ImageDescriptable.drawGreaterThan(g2D, 100, 30, 30);
		...
		this.cases.add(
			new CriterionCaseThumbnail(137, "la somme de bleu et jaune est inférieure à 6",
				(Graphics g2D) -> {
					...
					g2D.setColor(Color.BLACK);
					ImageDescriptable.drawLowerThan(g2D, 100, 30, 30);
