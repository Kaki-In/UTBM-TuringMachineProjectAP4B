...
{
    public abstract void createImage(Graphics2D g2D);

    public static void drawTriangle(Graphics2D g2D, int x, int y, int size)
    {
    ...
    public static void drawSquare(Graphics2D g2D, int x, int y, int size)
    {
    ...
    public static void drawIndex(Graphics2D g2D, CodeIndex index, int x, int y, int size)
    {
        switch (index) {
    ...
    public static void draw1Value(Graphics2D g2D, int x, int y, int size)
    {
    ...
    public static void draw2Value(Graphics2D g2D, int x, int y, int size)
    {
        int topx = x-size/2 + size/5;
        int topy = y-size/2;
    ...
    public static void draw3Value(Graphics2D g2D, int x, int y, int size)
    {
        int topx = x-size/2 + size/5;
        int topy = y-size/2;
    ...
    public static void draw4Value(Graphics2D g2D, int x, int y, int size)
    {
        int topx = x-size/2 + size/5;
        int topy = y-size/2;
    ...
    public static void draw5Value(Graphics2D g2D, int x, int y, int size)
    {
        int topx = x-size/2 + size/5;
        int topy = y-size/2;
    ...
    public static void draw6Value(Graphics2D g2D, int x, int y, int size)
    {
        int topx = x-size/2 + size/5;
        int topy = y-size/2;
    ...
    public static void drawValue(Graphics2D g2D, CodeValue value, int x, int y, int size)
    {
        switch (value) {
            case CodeValue.ONE:
    ...
    public static void drawEquals(Graphics2D g2D, int x, int y, int size)
    {
        g2D.fillRoundRect(x - size/2, y-size/6, size, size/3, size/20, size/20);
        g2D.fillRoundRect(x - size/2, y+size/6, size, size/3, size/20, size/20);
    }

    public static void drawGreaterThan(Graphics2D g2D, int x, int y, int size)
    {
    ...
    public static void drawLowerThan(Graphics2D g2D, int x, int y, int size)
    {
        int cossize = Math.round((float) (Math.cos(Math.PI/4)*size/2));
    ...
    public static void drawGreaterEqualThan(Graphics2D g2D, int x, int y, int size)
    {
        int cossize = Math.round((float) (Math.cos(Math.PI/4)*size/2));
    ...
    public static void drawLowerEqualThan(Graphics2D g2D, int x, int y, int size)
    {
        int cossize = Math.round((float) (Math.cos(Math.PI/4)*size/2));
    ...
    public static void drawPlus(Graphics2D g2D, int x, int y, int size)
    {
        g2D.drawLine(x-size/4, y, x+size/4, y);
        g2D.drawLine(x, y-size/4, x, y+size/4);
    }

    public static void drawMult(Graphics2D g2D, int x, int y, int size)
    {
        g2D.drawLine(x-size/4, y-size/4, x+size/4, y+size/4);
        g2D.drawLine(x+size/4, y-size/4, x-size/4, y+size/4);
    }

    public static void drawSeparation(Graphics2D g2D, int x, int y, int size)
    {
        g2D.drawLine(x, y-size/2, x, y+size/2);
    }

    public static void drawTopRightArrow(Graphics2D g2D, int x, int y, int size)
    {
    ...
    public static void drawBottomRightArrow(Graphics2D g2D, int x, int y, int size)
    {
        g2D.drawLine(x-size/2, y-size/2, x+size/2, y+size/2);
    ...
    public static void drawTopDownArrows(Graphics2D g2D, int x, int y, int size)
    {
    ...
    public static void drawValueSubline(Graphics2D g2D, int x, int y, int size)
    {
    ...
    public static void drawPodium(Graphics2D g2D, int height1, int height2, int height3, int x, int y, int size)
    {
        int topx = x-size/2;
        int topy = y-3*size/8;
    ...
    public static void drawBalance(Graphics2D g2D, int x, int y, int size)
    {
        int ysize = size/2;
